...
const Tier1SellerPortal: React.FC = () => {
  ...
  const loadTier2Sellers = async () => {
    ...
    try {
      ...
      console.log('Tier2 sellers loaded successfully:', tier2Data);
      console.log('Setting tier2Sellers state with:', tier2Data);
  ...
  const renderTier2Sellers = () => {
    console.log('renderTier2Sellers called with tier2Sellers:', tier2Sellers);
    return (
      <div className="space-y-6">
